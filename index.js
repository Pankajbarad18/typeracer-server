...
const getSentence = require('./api/sentence_api');
...
//Connection
const DB = 'mongodb+srv://Pankaj:Admin123@cluster0.kw6imrv.mongodb.net/?retryWrites=true&w=majority';
...
const calculateWPM = (endTime,startTime,player) => {
    ...
    let wordSpeed = player.currentWordIndex;
    const WPM = Math.floor(wordSpeed/timeTaken);
    return WPM;
};
